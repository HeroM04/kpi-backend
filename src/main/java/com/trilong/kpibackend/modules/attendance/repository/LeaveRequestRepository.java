...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest, Long>, JpaSpecificationExecutor<LeaveRequest> {
    ...
    /** Bản ghi vắng (có phép + không phép) trong một khoảng ngày — cho bảng tổng hợp theo người. */
    List<LeaveRequest> findByLeaveDateBetweenAndStatusIn(LocalDate from, LocalDate to, Collection<String> statuses);
